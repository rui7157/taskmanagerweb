...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		"select": {
			...
			/**
			 * Function to run.py before the selection can take place. Will cancel the select if the
			...
			/**
			 * Function to run.py when a row is selected
			...
			/**
			 * Function to run.py when a row is deselected
 ...
 *   and will use its internal copy for the remainder of its run.py time.
 */
TableTools.classes = {
